...
make('文学 · LITERATURE','说出一位「建安七子」。','使用常见姓名。','孔融|Kong Rong;王粲|Wang Can;陈琳|Chen Lin;刘桢|Liu Zhen;徐干|Xu Gan;阮瑀|Ruan Yu;应玚|Ying Yang'),
make('音乐 · MUSIC','说出一位常见的巴洛克时期作曲家。','本题收录 12 位作曲家；使用姓氏或常用中文译名。','巴赫|Bach|Johann Sebastian Bach;维瓦尔第|Vivaldi;亨德尔|Handel;帕赫贝尔|Pachelbel;蒙特威尔第|Monteverdi;泰勒曼|Telemann;斯卡拉蒂|Scarlatti;普赛尔|Purcell;科雷利|Corelli;拉莫|Rameau;吕利|Lully;库普兰|Couperin'),
